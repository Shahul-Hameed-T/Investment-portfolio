    ...
    throws IOException, ServletException{  
        ...
        try {
            ...
            "<head>"+
                ...
                "<script src=\"ViewPortfolioManagerScript.js\"></script>"+
            "</head>"+
            "<body>"+
                "<div class=\"navbar\">"+
                ...
                "<div id=\"side_panel\" class=\"sidenav\">"+
                    "<div style=\"display:flex; flex-direction: column; justify-content:space-around; align-items: center; width: 100%; height:85%;\">"+
                        ...
                        "<form id=\"group_form\" action=\"http://localhost:7071/Miniproject/ViewGroup\" method=\"get\" style=\"display:flex; flex-direction: row; justify-content:space-evenly; align-items: center; width: 100%;\">"+
                            "<img src=\"group.png\" id=\"group_img\" width=\"35px\" height=\"35px\">"+
                        ...
                        "<form id=\"logout_form\" action=\"http://localhost:7071/Miniproject/LogoutManager\" method=\"get\" style=\"display:flex; flex-direction: row; justify-content:space-evenly; align-items: center; width: 100%;\">"+
            ...
            while(rs1.next())
            {
                ...
                out.print("<form action=\"http://localhost:7071/Miniproject/SellStockManager\" style=\"display: inline; float: right;\">"+
            ...
            while(rs2.next())
            {
                ...
                out.print("<form action=\"http://localhost:7071/Miniproject/SellMFManager\" style=\"display: inline; float: right;\">"+
            ...
            while(rs3.next())
            {
                ...
                out.print("<form action=\"http://localhost:7071/Miniproject/SellBullionManager\" style=\"display: inline; float: right;\">"+
            ...
            out.println("<form action=\"http://localhost:7071/Miniproject/AddStocksManager\" method=\"get\">" +
                    "<input type=\"hidden\" id=\"status\" name=\"status\" value='" + status + "'>"+ 
            ...
            out.println("<form action=\"http://localhost:7071/Miniproject/AddMFManager\" method=\"get\">" +
                    "<input type=\"hidden\" id=\"status\" name=\"status\" value='" + status + "'>"+ 
                    "<input type=\"hidden\" id=\"username\" name=\"username\" value='" + username + "'>"+ 
            ...
            out.println("<form action=\"http://localhost:7071/Miniproject/AddBullionManager\" method=\"get\">" +
                    "<input type=\"hidden\" id=\"status\" name=\"status\" value='" + status + "'>"+ 
                    "<input type=\"hidden\" id=\"username\" name=\"username\" value='" + username + "'>"+ 
