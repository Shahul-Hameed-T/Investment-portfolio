    ...
    throws IOException, ServletException{  
        ...
        try {
            ...
            "<head>"+
                ...
                "<link rel=\"stylesheet\" href=\"ViewPortfolioStyle.css\">"+
                "<script src=\"ViewPortfolioScript.js\"></script>"+
            "</head>"+
            "<body>"+
                "<div class=\"navbar\">"+
                ...
                "<div id=\"side_panel\" class=\"sidenav\">"+
                    "<div style=\"display:flex; flex-direction: column; justify-content:space-around; align-items: center; width: 100%; height:85%;\">"+
                        "<form id=\"chat_form\" action=\"http://localhost:7071/Miniproject/Chat\" method=\"get\" style=\"display:flex; flex-direction: row; justify-content:space-evenly; align-items: center; width: 100%;\">"+
                            "<img src=\"request.png\" id=\"chat_img\" width=\"35px\" height=\"35px\">"+
                        ...
                        "<form id=\"stocks_form\" action=\"http://localhost:7071/Miniproject/ViewStocks\" method=\"get\" style=\"display:flex; flex-direction: row; justify-content:space-evenly; align-items: center; width: 100%;\">"+
                            "<img src=\"stocks.png\" id=\"stocks_img\" width=\"35px\" height=\"35px\">"+
                            "<input type=\"hidden\" id=\"status\" name=\"status\" value='" + status + "'>"+
                            "<input type=\"submit\" id=\"stocks\" value=\"Stock\" style=\"background:none; width: 12vw; height: 35px; font-weight: 700; text-align:start;\">"+
                        "</form>"+
                        
                        "<form id=\"mf_form\" action=\"http://localhost:7071/Miniproject/ViewMF\" method=\"get\" style=\"display:flex; flex-direction: row; justify-content:space-evenly; align-items: center; width: 100%;\">"+
                            "<img src=\"mf.png\" id=\"mf_img\" width=\"35px\" height=\"35px\">"+
                            "<input type=\"hidden\" id=\"status\" name=\"status\" value='" + status + "'>"+
                            "<input type=\"submit\" id=\"mf\" value=\"Mutual Fund\" style=\"background:none; width: 12vw; height: 35px; font-weight: 700; text-align:start;\">"+
                        "</form>"+

                        "<form id=\"bullion_form\" action=\"http://localhost:7071/Miniproject/ViewBullion\" method=\"get\" style=\"display:flex; flex-direction: row; justify-content:space-evenly; align-items: center; width: 100%;\">"+
                            "<img src=\"bullion.png\" id=\"bullion_img\" width=\"35px\" height=\"35px\">"+
                            "<input type=\"hidden\" id=\"status\" name=\"status\" value='" + status + "'>"+
                        ...
                        "<form id=\"logout_form\" action=\"http://localhost:7071/Miniproject/Logout\" method=\"get\" style=\"display:flex; flex-direction: row; justify-content:space-evenly; align-items: center; width: 100%;\">"+
                            "<img src=\"logout.png\" id=\"logout_img\" width=\"35px\" height=\"35px\">"+
                            "<input type=\"hidden\" id=\"status\" name=\"status\" value=" + status + ">"+
            ...
            while(rs.next())
            {
                ...
                out.print("<form action=\"http://localhost:7071/Miniproject/SellBullion\" style=\"display: inline; float: right;\">"+
                ...
                out.print("<form action=\"http://localhost:7071/Miniproject/DeleteBullion\" style=\"display: inline; float: right;\">"+
                    "<input type=\"hidden\" id=\"status" + count + "\" name=\"status\" value="+status+">"+
                    "<input type=\"hidden\" id=\"scheme_hidden" + count + "\" name=\"scheme\" value="+rs.getString("scheme")+">"+
                    "<input type=\"hidden\" id=\"purchase_price_hidden" + count + "\" name=\"purchase_price\" value="+ rs.getString("purchase_price") +">"+
                    "<input type=\"hidden\" id=\"price_hidden" + count + "\" name=\"price\" value="+ rs.getString("price") +">"+
            ...
            out.println("<form action=\"http://localhost:7071/Miniproject/AddBullion\" method=\"get\">" +
                    "<input type=\"hidden\" id=\"status\" name=\"status\" value='" + status + "'>"+ 
