    ...
    throws IOException, ServletException{  
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                out.print("<form action=\"http://localhost:7071/Miniproject/ViewAssets\" style=\"display: inline; float: right;\">"+
            ...
            out.println("<form action=\"http://localhost:7071/Miniproject/AddMember\" method=\"get\">" +
                    "<input type=\"hidden\" id=\"status\" name=\"status\" value='" + status + "'>"+ 
